function envioDados(dados) {
    ...
    function ativarEvento(evento){
        ...
        if (imc < 18.5){
            ...
            resultado.innerHTML += `<h1>Você está com Sobrepeso ele é:  ${imc.toFixed(2)}</h1>`;            
        } else if (imc >= 30 && imc <= 34.5 ) {
            console.log("Você está com Obsidade grau 1");
            resultado.innerHTML += `<h1>Você está com Obsidade grau 1:  ${imc.toFixed(2)}</h1>`; 
        } else if (imc >= 35 && imc <= 39.9 ) {
            console.log("Você está com Obsidade grau 2");
            resultado.innerHTML += `<h1>Você está com Obsidade grau 2: ${imc.toFixed(2)}</h1>`; 
        } else if (imc >= 40){
            console.log("Você está com Obsidade grau 3");
            resultado.innerHTML += `<h1>Você está com Obsidade grau 3: ${imc.toFixed(2)}</h1>`;
        } else{
